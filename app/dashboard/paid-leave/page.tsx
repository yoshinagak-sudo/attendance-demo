...
export default async function DashboardPaidLeavePage({
  searchParams,
}: {
    ...
    <>
      <header className="dash-page-head">
        <div className="dash-page-head-main">
          <span className="dash-page-eyebrow">有給付与</span>
          <h1 className="dash-page-title">有給付与</h1>
          <span className="dash-page-sub">手動付与・自動付与実行・ユーザー別残日数</span>
        </div>
        <div className="dash-page-side">
          <Link href="/dashboard/attendance" className="link">
            勤怠申請へ
          </Link>
        </div>
      </header>
